...
if (isset($_SESSION['loggedUserEmail'])) {
    ...
    if (!mysqli_query($link, $user)) {
        ...
        if (empty($urow['firstname']) || empty($urow['lastname']) || empty($urow['address']) || empty($urow['zip']) || empty($urow['city']) || empty($urow['apt']) || empty($urow['country'])) {
        ...
        <nav class="navbar navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                <button type="button" class="navbar-toggle pull-left" data-toggle="collapse" data-target=".navbar-ex1-collapse">
                    <i class="fa fa-navicon" style="color:#000;"></i>
                </button>
