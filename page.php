...
<html>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="content">
                <?php
                    $banner = "Select * from pages where type='banner'and status='active' and id='$id';";
                ...
                ?>
                <?php 
                    $sql = "Select * from pages where type='section' and pageid='$id' order by fieldorder asc";
...
//                                echo "</div>";
                ...
                <?php
                    ...
                    //advertisements
                    $advSql = "Select * from advertisements where status='active' and visibility like '%,page%';";
