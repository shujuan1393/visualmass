...
<html>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="content">
                <?php
                    $banner = "Select * from ourstory where page='design' and type='banner';";
                ...
                ?>
                <?php 
                    $sql = "Select * from ourstory where page='design' and type='section' and status='active' order by fieldorder asc";
                ...
                <?php
                    ...
                    $advSql = "Select * from advertisements where status='active' and visibility like '%design%';";
