...
if (isset($_POST['submitted'])) {
    ...
    if (!mysqli_query($link, $getmail)) {
        ...
        if ($mailresult -> num_rows === 0) {
            ...
            $sql = "INSERT INTO mailinglist (email, preference) VALUES ('$email', '$preference');";
...
<html>
        ...
        <div id="mailingWrapper">
            ...
            <div id='login'>
                ...
                <form id='mailingForm' autofocus>
                    ...
                    <button class='button' id='men'>MEN</button>
                    <button class='button' id='women'>WOMEN</button>
                </form>
            </div>
    ...
    <script>
        ...
        document.getElementById('men').onclick = function() {
            document.getElementById('preference').value = "men";
            $('form#mailingForm').submit();
        };
        
        document.getElementById('women').onclick = function() {
            document.getElementById('preference').value = "women";
            $('form#mailingForm').submit();
        };
